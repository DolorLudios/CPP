...
int Complex::precision_ = kDefaultPrecision;
...
int main() {
    ...
    int prec;
    cout << "Enter precision: "; cin >> prec;
    z1.SetPrecision(prec);
    cout << "z1 = "; z1.PrintExpF();
    cout << "z2 = "; z2.PrintExpF();
    cout << endl;

    result = z1.Add(z2);
    cout << "z1 + z2 = "; result.PrintTrigF();
